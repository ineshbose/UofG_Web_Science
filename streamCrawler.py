...
consumer_key = "EiGyOze .... kVWN4xJ"
consumer_secret ="eRpAtSZtb..... P0Is1PeL2RaTcJ0E"
access_token ="26711278-yoA5..... y6PXJL3NWikJIHpD"
access_token_secret ="UQn1J5t7zU.....YkVMqvXOpk4y"
...
def processTweets(tweet):
    ...
    tweet1 = {'_id' : tweet_id, 'date': created, 'username': username,  'text' : text,  'geoenabled' : geoenabled,  'coordinates' : coordinates,  'location' : location,  'place_name' : place_name, 'place_country' : place_country, 'country_code': place_countrycode,  'place_coordinates' : place_coordinates, 'hashtags' : hList, 'mentions' : mList, 'source' : source}
